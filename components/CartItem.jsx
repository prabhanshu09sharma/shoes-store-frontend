        ...
        <div className='flex py-5 gap-3 md:gap-5 border-b'>
            ...
            <div className='shrink-0 aspect-square w-[50px] md:w-[120px]'>
                <Image src={p?.thumbnail?.data?.attributes?.url}
                    width={120} height={120} alt={p?.name} />
            </div>
            {/* Image end  */}
            <div className='w-full flex flex-col'>
                <div className='flex flex-col md:flex-row justify-between'>
                    ...
                    {/* product subtitle mobile screen start  */}
                    <div className='text-sm md:text-md font-medium text-black/[0.5] 
                    block md:hidden'>
                        {p?.subtitle}
                    </div>
                    {/* product subtitle mobile screen end  */}
                    {/* Product prize  */}
                    <div className='text-sm md:text-md font-bold text-black/[0.5] mt-2'>
                        ₹:{p?.price}
                    </div>
                </div>
                {/* product subtitle medium screen  */}
                ...
                <div className='flex items-center justify-between mt-4'>
                    ...
                    text-sm md:text-md'>
                        <div className='flex items-center gap-1'>
                            <div className='fon-semibold'> Size:</div>
                            <select className='hover:text-black text-sm md:text-md'
                                onChange={(e) =>
                        ...
                        <div className='flex items-center gap-1'>
                            <div className='fon-semibold'> Quantity</div>
