            ...
            <Wrapper className="h-[60px] flex justify-between items-center">
                ...
                <div className='flex items-center gap-2 text-black'>
                    ...
                    items-center hover:bg-black/[0.05] cursor-pointer relative'>
                        ...
                        <div className='h-[14] md:h-[18px] min-w-[14px] md:[18px] 
                        rounded-full bg-red-500 absolute top-1 left-5 md:left-7 text-white 
                        text-[10px] md:text-[12px] flex items-center justify-center px-[2px] md:px-[5px] hover:bg-red-600 '
                        >
                            12
                        </div>
                    </div>
                    ...
                    items-center hover:bg-black/[0.05] cursor-pointer relative'>
                            ...
                            {cartItems.length > 0 && <div className='h-[14] md:h-[18px] min-w-[14px] md:[18px] 
                        rounded-full bg-red-500 absolute top-1 left-5 md:left-7 text-white 
                        text-[10px] md:text-[12px] flex items-center justify-center px-[2px] md:px-[5px] hover:bg-red-600 '
                            >
                                {cartItems.length}
                    ...
                    items-center hover:bg-black/[0.05] cursor-pointer relative -mr-2'>
                        {mobileMenu ? (
                            <VscChromeClose className='text-[16px]  md:hidden flex'
                                onClick={() => setMobileMenu(false)}
                            />

                        ) : (
                            <BiMenuAltRight className='text-[20px] md:hidden flex'
